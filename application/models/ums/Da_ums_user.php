...
class Da_ums_user extends ums_model {		
	...
	function insert() {
		...
		$sql = "INSERT INTO ums_user (us_id, us_name, us_username, us_password, us_password_confirm, us_ps_id, us_psd_id_card_no, us_bg_id, us_active, us_sync, us_create_user, us_create_date, us_update_user, us_update_date, us_dp_id, us_email, us_detail)
				VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), ?, NOW(), ?, ?, ?)";
		 
		$this->ums->query($sql, array($this->us_id, $this->us_name, $this->us_username, $this->us_password, $this->us_password_confirm, $this->us_ps_id, $this->us_psd_id_card_no, $this->us_bg_id, $this->us_active, $this->us_sync, $this->us_create_user, $this->us_update_user, $this->us_dp_id, $this->us_email, $this->us_detail));
