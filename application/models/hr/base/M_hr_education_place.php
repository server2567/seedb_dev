<?php
/*
* m_hr_education_place
* Model for Manage about hr_base_education_place Table.
* @Author Jiradat Pomyai
* @Create Date 30/05/2024
*/
include_once("Da_hr_education_place.php");

class m_hr_education_place extends Da_hr_education_place {
	...
	*/
	function update_active($active){
		$sql = "UPDATE ".$this->hr_db.".`hr_base_place` 
				SET `place_active` = '".$active."' 
				WHERE `hr_base_place`.`place_id` = ?;";
	...
	*/
	function get_all_by_active($delete="2"){
		...
		WHERE place_active != '$delete'
		ORDER BY place_active DESC,place_id DESC";
		$query = $this->hr->query($sql);
		return $query;
	}
