...
*/
include_once("Da_hr_vocation.php");

class m_hr_vocation extends Da_hr_vocation {
	...
	*/
	function get_all_by_active($delete="2"){
		...
		WHERE voc_active != '$delete'
		ORDER BY voc_active DESC,voc_id DESC";
		$query = $this->hr->query($sql);
		return $query;
	}
