...
*/
include_once("Da_hr_person_status.php");

class M_hr_person_status extends Da_hr_person_status {
	...
	*/
	function get_all_by_active($delete="2"){
		$sql = "SELECT * 
				...
				WHERE psst_active != '$delete'
				ORDER BY psst_active DESC,psst_id DESC";
		$query = $this->hr->query($sql);
		return $query;
	}
