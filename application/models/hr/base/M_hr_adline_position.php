<?php
/*
* M_hr_adline_position
* Model for Manage about hr_base_adline_position Table.
* @Author Jiradat Pomyai
* @Create Date 30/05/2024
*/
include_once("Da_hr_adline_position.php");

class m_hr_adline_position extends Da_hr_adline_position {
	...
	*/
	function update_active($active){
		$sql = "UPDATE ".$this->hr_db.".`hr_base_adline_position` 
				SET `alp_active` = '".$active."' 
				WHERE `hr_base_adline_position`.`alp_id` = ?;";
	...
	*/
	function get_all_by_active($delete="2"){
		...
		WHERE alp_active != '$delete'
		ORDER BY alp_active DESC,alp_id DESC";
		$query = $this->hr->query($sql);
		return $query;
	}
