<?php
/*
* m_hr_education_major
* Model for Manage about hr_base_education_major Table.
* @Author Jiradat Pomyai
* @Create Date 30/05/2024
*/
include_once("Da_hr_education_major.php");

class m_hr_education_major extends Da_hr_education_major {
	...
	*/
	function update_active($active){
		$sql = "UPDATE ".$this->hr_db.".`hr_base_education_major` 
				SET `edumj_active` = '".$active."' 
				WHERE `hr_base_education_major`.`edumj_id` = ?;";
	...
	*/
	function get_all_by_active($delete="2"){
		...
		WHERE edumj_active != '$delete'
		ORDER BY edumj_active DESC,edumj_id DESC";
		$query = $this->hr->query($sql);
		return $query;
	}
