...
*/
include_once("Da_hr_structure_position.php");

class M_hr_structure_position extends Da_hr_structure_position {
	...
	*/
	function get_all_by_active($orderby='DESC',$delete="2"){
		$sql = "SELECT * 
				FROM ".$this->hr_db.".hr_base_structure_position
				WHERE stpo_active != '$delete'
				ORDER BY stpo_active DESC,stpo_id $orderby";
		$query = $this->hr->query($sql);
		return $query;
	}
