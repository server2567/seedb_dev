...
*/
include_once("Da_hr_hire.php");

class m_hr_hire extends Da_hr_hire {
	...
	*/
	function get_all_by_active($delete="2"){
		...
		WHERE hire_active != '$delete'
		ORDER BY hire_active DESC,hire_id DESC";
		$query = $this->hr->query($sql);
		return $query;
	}
