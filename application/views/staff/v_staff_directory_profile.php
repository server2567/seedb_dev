...
<script>
  ...
  function loadContent(url, params = {}) {
    ...
    fetch(urlWithParams)
      ...
      .then(data => {
        // ใช้ DOMParser เพื่อแปลง string เป็น document
        var parser = new DOMParser();
        var doc = parser.parseFromString(data, 'text/html');

        // ค้นหา element ภายใน data
        ...
        if (top) {
          ...
          // อัปเดตคลาสสำเร็จแล้ว, จากนั้นใส่ข้อมูลไปยัง content
  ...
  function filter_profile() {
    ...
    if (button) {
      ...
      activateCard(check + '-card', '<?= site_url('staff/Directory_profile/') ?>' + '/' + check, {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    document.getElementById("doctors-card").addEventListener("click", function() {
      activateCard('doctors-card', '<?= site_url('staff/Directory_profile/doctors') ?>', {
        ft_name: '',
        ft_stde: 'all'
      });
    });
    // document.getElementById("nurses-card").addEventListener("click", function() {
    //   activateCard('nurses-card', '<?= site_url('staff/Directory_profile/nurses') ?>', {
    //     ft_name: '',
    //     ft_stde: 'all'
    //   });
    // });
    ...
    //   activateCard('staff-card', '<?= site_url('staff/Directory_profile/staff') ?>', {
    //     ft_name: '',
    //     ft_stde: 'all'
    //   });
    // });
