        ...
        <div class="accordion-item">
            ...
            <div id="collapseAdd" class="accordion-collapse collapse show"  aria-labelledby="headingAdd">
                <div class="accordion-body">
                    <form class="row g-3 needs-validation" novalidate id="departmentForm" method="post" action="<?php echo base_url(); ?>index.php/ams/Base_notify/update/<?php echo $info->ntf_id ?>" >
                        <div class="col-md-6">
                            <label for="ntf_name" class="form-label">ชื่อประเภทการแจ้งเตือน (ภาษาไทย)</label>
                            <input type="text" class="form-control required" name="ntf_name" value="<?php if(isset($info->ntf_name)){echo $info->ntf_name; } ?>" id="ntf_name" placeholder="ชื่อประเภทการแจ้งเตือนภาษาไทย"  oninput="validateThaiInput(this)" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="ntf_name_en" id="ntf_name_en" value="<?php if(isset($info->ntf_name_en)){echo $info->ntf_name_en; } ?>" id="ntf_name" placeholder="ชื่อประเภทการแจ้งเตือนภาษาอังกฤษ"  oninput="validateEnglishInput(this)" required>
                            <p id="errorMessage" style="color: red; display: none;">โปรดกรอกภาษาอังกฤษ</p>
                        </div>
                        <div class="col-md-6">
                            <label for="ntf_active" class="form-label">สถานะ</label>
                            <div class="form-check">
                                <input <?php if($info->ntf_active=='1'){echo 'checked';} ?> class="form-check-input" type="checkbox" name="ntf_active" id="ntf_active" >
