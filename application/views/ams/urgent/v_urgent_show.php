        ...
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <div class="float-end">
                    ...
                    <button type="button" onclick="updateNotifyData()" class="btn btn-primary">แจ้งเตือน</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function() {
                    ...
                    <div class="accordion-body m-1">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <textarea class="form-control mt-2 infoTextarea tinymce-editor" style="height:100px;" name="" id="infoTextarea-${patientId}">${person.detail_appointment}</textarea>
                            </div>
                            <div class="col-6">
                                <p><b>การเตรียมตัวก่อนมาพบแพทย์ </b><span class="text-danger"> *</span></p>
                                <textarea class="form-control mt-2 prepareTextarea tinymce-editor" style="height:100px;" name="" id="prepareTextarea-${patientId}">${person.detail_prepare}</textarea>
                            </div>
        ...
        $(document).on('input', '.prepareTextarea', function() {
            const $selectedPatientRow = $(this).closest('.accordion-body'); // หากข้อมูลใน textarea ในหน้าต่างที่เปิดอยู่
            const patientId = $selectedPatientRow.find('#selectedPatientId').text().trim(); // รับ ID ของผู้ป่วยที่เลือก
            const infoText = $(this).val(); // รับค่าของ textarea ที่กรอก
            if (!personInfo[patientId]) {
