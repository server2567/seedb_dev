    ...
    <div class="row w-100">
        <div id ="topbar_head" class="col-12 col-sm-12 col-md-12 col-lg-3">
          <a href="#" class="logo align-items-center">
            <!-- <img  src="<?php echo base_url(); ?>assets/img/apple-touch-icon2.png" alt="" class="img-width" style="width: 25%; margin-right: 20px; margin-right: 0px;"> -->
            <span class="font-40">คลินิกบรรยงจักษุ</span>
          </a>
        </div>
        <div class="col-md-9">
          <div class="row">
