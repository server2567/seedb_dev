    ...
    <div class="col-3">
      <div class="row">
        ...
        <div class="col-12">
          <div class="card">
            <div class="filter filterDetail">
              <a class="bi-search btn btn-outline-primary p-1 ps-2 pe-2 font-14" data-toggle="tooltip" data-placement="top" data-bs-toggle="modal" href="#" aria-label="คลิกเพื่อดูรายละเอียด" data-bs-original-title="คลิกเพื่อดูรายละเอียด"></a>
            </div>
            <div class="card-body">
...
<script>
  ...
  setTimeout(function() {
    ...
    Highcharts.chart('container_g4', {
      ...
      xAxis: {
        categories: ['Dr. A', 'Dr. B', 'Dr. C', 'Dr. D', 'Dr. E'],
        labels: {
          style: {
            fontSize: '16px'
          },
          ...
          formatter: function() {
            var images = {
              'Dr. A': '<?php echo site_url(); ?>/hr/getIcon?type=profile/profile_picture&image=profile_picture_2.jpg',
              'Dr. B': '<?php echo site_url(); ?>/hr/getIcon?type=profile/profile_picture&image=profile_picture_2.jpg',
              'Dr. C': '<?php echo site_url(); ?>/hr/getIcon?type=profile/profile_picture&image=profile_picture_2.jpg',
              'Dr. D': '<?php echo site_url(); ?>/hr/getIcon?type=profile/profile_picture&image=profile_picture_2.jpg',
              'Dr. E': '<?php echo site_url(); ?>/hr/getIcon?type=profile/profile_picture&image=profile_picture_2.jpg'
            };
            return '<img src="' + images[this.value] + '" style="width: 30px; height: 30px; border-radius: 50%;"><br><span>' + this.value + '</span>';
          }
        },
        tickWidth: 0,
        lineWidth: 0,
      ...
      series: [{
        ...
        color: '#40b780',
        data: [30, 28, 40, 10, 20] // จำนวนผู้ป่วยที่ไม่เกินเวลา
      }, {
        name: 'จำนวนผู้ป่วย (เกินเวลา)',
        color: '#e74c3c',
        data: [20, 0, 5, 0, 0] // จำนวนผู้ป่วยที่เกินเวลา
      }]
    });

    Highcharts.chart('container_g3', {
      chart: {
        type: 'column'
      },
      title: {
      ...
      xAxis: {
        categories: [
          ...
          'เข้ารับการรักษาที่แผนก',
          'ตรวจเครื่องมือทำหัตถการ',
          'พบแพทย์',
          'ชำระเงิน',
          'จ่ายยา'
        ],
      ...
      series: [{
        name: 'ไม่เกินเวลา',
        color: '#40b780',
        data: [100, 80, 90, 70, 60, 110, 50, 120] // จำนวนผู้ป่วยที่ไม่เกินเวลาในแต่ละจุดบริการ
      }, {
        name: 'เกินเวลา',
        color: '#e74c3c',
        data: [20, 30, 10, 40, 50, 20, 60, 10] // จำนวนผู้ป่วยที่เกินเวลาในแต่ละจุดบริการ
      }]
    });

    Highcharts.chart('container_g5', {
      chart: {
        type: 'pie'
      },
      title: {
