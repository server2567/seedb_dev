<?php $this->load->view($view_dir . 'v_seedb_ams_style'); ?>
        ...
        <div class="autocomplete mx-auto" style="width:70%;">
            <svg viewbox="0 0 1000 50" class='pb-3'>
                <clipPath id="text" class="filled-heading ">
                    <text y="40" class="fw-bold">ระบบแจ้งเตือนการนัดหมายและการแจ้งเตือนผลการตรวจจากห้องปฏิบัติการทางการแพทย์</text>
                </clipPath>
    ...
    <div class="row">
        <!-- <div class="col-md-3">
            <div class="card info-card sales-card" style="border-bottom: 3px solid #9b2500; background: #FFF;">
                <div class="card-body pb-2">
                    <h5 class="card-title pt-1 pb-3 pe-5 font-16">[AMS-C1] จำนวนการนัดหมายผู้ป่วย</h5>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title pt-1 pb-0 font-16 w-80">[AMS-1] จำนวนการนัดหมายโดยแพทย์ จำแนกตามวันของสัปดาห์ตารางเวร ประจำเดือน สิงหาคม 2567</h5>
                    <hr>
...
<script>
    // colors
    const dayColors = [
        "#FAFABE", // Monday - Light Coral
        "#F6C2F3", // Tuesday - Light Salmon
        "#C1EBC0", // Wednesday - Light Pink
        "#F6CA94", // Thursday - Soft Rose
        "#C7CAFF", // Friday - Light Lavender
        "#CDABEB",  // Saturday - Light Blue
        "#F09EA7", // Sunday - Light Peach
    ];

    let data = [
        {
            name: 'จันทร์',
            data: [1, 3, 5, 2, 3, 1, 0, 4, 0, 1],
            color: dayColors[0]
        }, {
            name: 'อังคาร',
            data: [2, 4, 1, 0, 2, 3, 1, 0, 4, 0],
            color: dayColors[1]
        }, {
            name: 'พุธ',
            data: [3, 5, 2, 1, 0, 2, 3, 1, 0, 1],
            color: dayColors[2]
        }, {
            name: 'พฤหัสบดี',
            data: [4, 1, 3, 6, 7, 6, 4, 5, 6, 4],
            color: dayColors[3]
        }, {
            name: 'ศุกร์',
            data: [5, 2, 4, 2, 3, 1, 0, 4, 0, 1],
            color: dayColors[4]
        }, {
            name: 'เสาร์',
            data: [1, 3, 5, 6, 7, 6, 4, 5, 6, 4],
            color: dayColors[5]
        }, {
            name: 'อาทิตย์',
            data: [2, 4, 1, 2, 3, 1, 0, 4, 0, 1],
            color: dayColors[6]
        }
    ];
            ...
            tooltip: {
                ...
                formatter: function() {
                    ...
                    points.forEach(point => {
                        tooltip += '<span style="color:' + point.color + '">\u25CF</span> ' + point.series.name + ': ' + point.y + ' ครั้ง<br>';
                        total += point.y;
                });
                tooltip += '<br><b>รวมทั้งหมด: ' + total + ' ครั้ง</b>';
                return tooltip;
                }
            },
            series: data,
