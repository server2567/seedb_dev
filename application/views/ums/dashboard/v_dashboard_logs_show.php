        ...
        <div class="accordion-item">
            ...
            <div id="collapseAdd" class="accordion-collapse collapse" aria-labelledby="headingAdd">
                <div class="accordion-body">
				    <form class="row g-3" method="post" action="<?php echo base_url(); ?>index.php/ums/Dashboard_logs">
                        <div class="col-md-6">
                            <label for="date" class="form-label ">ระหว่าง วันที่</label>
                            <div class="input-group date input-daterange">
                                <input type="text" class="form-control" name="start_date" id="start_date" placeholder="วว/ดด/ปป">
                                <span class="input-group-text mb-3">ถึง</span>
                                <input type="text" class="form-control" name="end_date" id="end_date" placeholder="วว/ดด/ปป">
                            </div>
                        </div>
                        <div class="col-md-6">
        ...
        <div class="accordion-item">
            <h2 class="accordion-header">
                <button class="accordion-button accordion-button-table" type="button">
                    <i class="bi-clock-history icon-menu"></i><span>  ประวัติการเข้าใช้ระบบ</span><span class="badge bg-success"><?php echo count($logs); ?></span>
                </button>
            </h2>
                    ...
                    <table class="table datatable" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th width="15%" class="text-center">รหัสประจำตัวบุคลากร</th>
                                <th width="20%">ชื่อผู้ใช้</th>
                                <th width="30%">การดำเนินการ</th>
                                <th width="15%" class="text-center">วันที่ดำเนินการ</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['log_changed']; ?></td>
                                <td class="text-center"><?php echo convertToThaiYear($row['log_date'], true); ?></td>
                                </tr>
                            <?php 
                                $i++; } 
                            ?>
