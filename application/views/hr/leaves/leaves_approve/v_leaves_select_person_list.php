            ...
            success: function(data) {
                ...
                data.forEach(function(row, index) {
                    ...
                    var button = `  <div class="text-center option">
                                            <button class="btn btn-primary" title="คลิกเพื่ออนุมัติการลา" data-toggle="tooltip" data-bs-placement="top" onclick="window.location.href='<?php echo site_url() . "/" . $controller_dir; ?>get_leaves_person_list/${row.ps_id}'">
