<?php
	/*
	* v_leaves_form_input_5
	* หน้าจอแบบฟอร์มการลาอุปสมบทหรือลาไปประกอบพิธีฮัจย์
        ...
        <div class="accordion-item">
            <h2 class="accordion-header">
                <button class="accordion-button accordion-button-table" type="button">
                    <i class="bi-receipt icon-menu"></i><span> แบบฟอร์มทำเรื่องการลาอุปสมบทหรือลาไปประกอบพิธีฮัจย์</span>
                </button>
            </h2>
                ...
                <div class="accordion-body">
                    ...
                    <form id="leaves_form_input" class="needs-validation" method="post" action="<?php echo site_url()."/".$controller; ?>leaves_save">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-10">
                                ขอลาอุปสมบทหรือลาไปประกอบพิธีฮัจย์
                            </div> 
                        </div>
                        <!-- เรื่อง -->
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-10">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <span>บัดนี้มีศรัทธาจะอุปสมบทหรือลาไปประกอบพิธีฮัจย์</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-2"><label for="leaves_detail" class="form-label">สถานที่<span class="text-danger"> *</span></label></div>
                            <div class="col-md-10">
                                <textarea class="form-control" name="leaves_detail" id="leaves_detail" style="height: 100px" placeholder="ตัวอย่าง วัดพระบรมธาตุไชยาราชวรวิหาร หมู่ที่ 3 ตำบลเวียง อำเภอไชยา จังหวัดสุราษฎร์ธานี"></textarea>
                            </div> 
                        </div>
                        <!-- สถานที่ -->
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-10">
                                ข้าพเจ้าได้ลาอุปสมบทหรือลาไปประกอบพิธีฮัจย์ ครั้งสุดท้ายตั้งแต่วันที่ 8 ธันวาคม พ.ศ. 2566 ถึงวันที่ 13 ธันวาคม พ.ศ. 2566 มีกำหนด 3 วัน
                            </div> 
                        </div>
                        <!-- ประวัติการลาอุปสมบทหรือลาไปประกอบพิธีฮัจย์ครั้งล่าสุด -->
