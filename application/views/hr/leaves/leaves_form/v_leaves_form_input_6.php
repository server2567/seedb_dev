<?php
	/*
	* v_leaves_form_input_6
	* หน้าจอแบบฟอร์มการลาไปศึกษา ฝึกอบรม ปฏิบัติการวิจัย หรือดูงาน
	* @input leave_type_id = 6
	* $output -
        ...
        <div class="accordion-item">
            <h2 class="accordion-header">
                <button class="accordion-button accordion-button-table" type="button">
                    <i class="bi-receipt icon-menu"></i><span> แบบฟอร์มทำเรื่องการลาไปศึกษา ฝึกอบรม ปฏิบัติการวิจัย หรือดูงาน</span>
                </button>
            </h2>
            <div id="collapseShow" class="accordion-collapse collapse show mb-3">
                <div class="accordion-body">
                    ...
                    <form id="leaves_form_input" class="needs-validation" method="post" action="<?php echo site_url()."/".$controller; ?>leaves_save">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-2"><label for="leaves_topic" class="form-label">หัวเรื่อง<span class="text-danger"> *</span></label></div>
                            <div class="col-md-10">
                                <input type="text" id="leaves_topic" name="leaves_topic" class="form-control" placeholder="ระบุหัวเรื่อง" value="">
                            </div> 
                        </div>
                        <!-- หัวเรื่อง -->

                        <div class="row mt-4">
                            <div class="col-md-2"><label for="leaves_detail" class="form-label">รายละเอียด<span class="text-danger"> *</span></label></div>
                            <div class="col-md-10">
                                <textarea class="form-control" name="leaves_detail" id="leaves_detail" style="height: 100px" placeholder="ระบุรายละเอียด"></textarea>
                            </div> 
                        </div>
                        <!-- สถานที่ -->

                        <div class="row mt-4">
                            <div class="col-md-2"><label for="leaves_place" class="form-label">สถานที่<span class="text-danger"> *</span></label></div>
                            <div class="col-md-10">
                                <textarea class="form-control" name="leaves_place" id="leaves_place" style="height: 100px" placeholder="ระบุสถานที่"></textarea>
                            </div> 
                        </div>
                        <!-- สถานที่ -->
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-10">
                                <div class="row">
                                <div class="col-md-6">
                                    <label for="leaves_status" class="form-label">จังหวัด</label>
                                    <select class="select2 form-control" name="leaves_status" id="leaves_status">
                                        <option value="-1" disabled>-- เลือกสถานะ --</option>
                                        <option value="1" selected>กรุงเทพมหานคร</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <label for="leaves_status2" class="form-label">ประเทศ</label>
                                    <select class="select2 form-control" name="leaves_status2" id="leaves_status2">
                                        <option value="-1" disabled>-- เลือกสถานะ --</option>
                                        <option value="1" selected>ประเทศไทย</option>
                                    </select>
                                </div>
                                </div>
                            </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-10">
                                ข้าพเจ้าได้ลาไปศึกษา ฝึกอบรม ปฏิบัติการวิจัย หรือดูงาน ครั้งสุดท้ายตั้งแต่วันที่ 8 ธันวาคม พ.ศ. 2566 ถึงวันที่ 13 ธันวาคม พ.ศ. 2566 มีกำหนด 3 วัน
                            </div> 
                        </div>
                        <!-- ประวัติการลาไปศึกษา ฝึกอบรม ปฏิบัติการวิจัย หรือดูงานครั้งล่าสุด -->
