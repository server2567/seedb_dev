<?php
	/*
	* v_leaves_form_input_3
	* หน้าจอแบบฟอร์มการลาพักผ่อน
	* @input leave_type_id = 3
	* $output -
        ...
        <div class="accordion-item">
            <h2 class="accordion-header">
                <button class="accordion-button accordion-button-table" type="button">
                    <i class="bi-receipt icon-menu"></i><span> แบบฟอร์มทำเรื่องการลาพักผ่อน</span>
                </button>
            </h2>
                ...
                <div class="accordion-body">
                    ...
                    <form id="leaves_form_input" class="needs-validation" method="post" action="<?php echo site_url()."/".$controller; ?>leaves_save">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-10">
                                ข้าพเจ้า นพ.บรรยง ขินกุลกิจนิวัฒน์ <b>ตำแหน่งในการบริหาร</b> ผู้อำนวยการ <b>ตำแหน่งในสายงาน</b> จักษุแพทย์ รักษาโรคตาทั่วไป <br><br>
                                มีวันลาพักผ่อนสะสม 16 วันทำการ  มีสิทธิลาพักผ่อนประจำปีนี้อีก 20 วันทำการ  ลาไปแล้ว 11 วันทำการ  เหลือวันลา 25 วันทำการ
                            </div> 
                        </div>
                        <!-- ชื่อผู้ดำเนินการ -->
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-10">
                                ข้าพเจ้าได้ลาพักผ่อน ครั้งสุดท้ายตั้งแต่วันที่ 8 ธันวาคม พ.ศ. 2566 ถึงวันที่ 13 ธันวาคม พ.ศ. 2566 มีกำหนด 3 วัน
                            </div> 
                        </div>
                        <!-- ประวัติการลาพักผ่อนครั้งล่าสุด -->
