                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <label class="col-md-12 control-label" style="text-align:left;">
                                    ...
                                    <b><u>หมายเหตุ</u></b> <b style="color:red">***</b> ทำเรื่องการ<?php echo $ctrl->leave_name; ?> ตั้งแต่ 2 วัน ต้องแนบใบรับรองแพทย์ และส่งใบลาในวันมาทำงานวันแรก
                                </label>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        document.getElementById('leaves_start_date').value = formatDateToThai(defaultEndDate);
    ...
    function leaves_save_form() {
        ...
        $('#leaves_form_input .form-control').each(function() {
            ...
            if (fieldName === "leaves_upload_file" && day >= 2 && $(this).val() === '') {
                isValid = false;
                text_valid = "ทำเรื่องการ<?php echo $ctrl->leave_name; ?> ตั้งแต่ 2 วัน ต้องแนบใบรับรองแพทย์<br>";
