            ...
            <div id="collapseAdd" class="accordion-collapse collapse show" aria-labelledby="headingAdd">
                <div class="accordion-body">
                    <form class="row g-3" method="get">
                        ...
                        <!-- ประเภทการทำงาน -->
                        <div class="col-md-3">
                            <label for="select_hire_type" class="form-label">ประเภทการทำงาน</label>
...
<script>
    ...
    function updateDataTable() {
        ...
        var hire_is_medical = $('#select_hire_is_medical').val();
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                data.forEach(function(row, index) {
                    ...
                    dataTable.row.add([
                        (index + 1),
                        '<div class="text-center option">' + row.mc_code + '</div>',
                        '<div class="text-center option">' + (row.pos_ps_code != null ? row.pos_ps_code : "") + '</div>',
    ...
    $('#select_dp_id, #select_status_id, #select_hire_is_medical, #select_hire_type').on('change', function() {
