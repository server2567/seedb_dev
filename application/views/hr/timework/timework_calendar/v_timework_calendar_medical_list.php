...
<ul class="nav nav-pills" id="tabTimework" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link w-100 active" id="form-tab" data-bs-toggle="tab" data-bs-target="#form-timework" type="button" role="tab" aria-controls="home" aria-selected="true">จัดการตารางแพทย์ออกตรวจ</button>
    </li>
    <li class="nav-item ms-1" role="presentation">
        <button class="nav-link w-100" id="history-tab" data-bs-toggle="tab" data-bs-target="#history-timework" type="button" role="tab" aria-controls="contact" aria-selected="false">รายงานตารางแพทย์ออกตรวจ (ภาพรวม)</button>
    </li>
</ul>
                            ...
                            <form class="row g-3" method="get">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select select2" name="fillter_select_hire_is_medical" id="fillter_select_hire_is_medical">
                                        <option value="M">สายการแพทย์</option>
                                    </select>
                                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if(default_show == 1){
        ...
        $('#fillter_select_dp_id, #fillter_select_hire_is_medical, #fillter_select_hire_type, #fillter_select_status_id, #filter_select_public').on('change', function() {
