                    ...
                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample" style="">
                        <div class="accordion-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="edu_edumj_id" class="form-label required">สาขาวิชา</label>
                                    <select class="form-select select2" data-placeholder="-- กรุณาเลือกสาขาวิชา --" name="edu_edumj_id" id="edu_edumj_id" required>
