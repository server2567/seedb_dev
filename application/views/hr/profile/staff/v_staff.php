    ...
    <div class="col-12 col-sm-6 col-md-4">
        <div class="form-floating mb-4">
            <select class="form-select" id="floatingSelect" aria-label="Floating label select example">
                <option value="all" selected="">ทุกฝ่าย/แผนก</option>
            ...
            <label for="floatingSelect">ค้นหาบุคลากร</label>
        </div>
    </div>
    <!-- <div class="col-12 col-sm-6 col-md-4">
        <div class="form-floating mb-2">
...
<div class="row justify-content-md-center mb-4 mt-2 text-center">
    <div class="col-12 col-sm-12 col-md-8">
        <button type="button" onclick="filter_profile()" id="seacrh_button" data-value="staff" class="btn btn-primary-search mb-2 w-100 font-20 float-start"><i class="bi bi-search"></i> ค้นหาตำแหน่ง</button>
    </div>
</div>
