        ...
        <div class="profile-body">
            <div class="tab-content">
                            ...
                            <div class="col-md-9 p-3 pt-2">
                                ...
                                <div class="row font-18" style="padding-left: 25px;">
                                    ...
                                    <div class="col-4 col-md-3 col-lg-3 text-start" style="padding-left:0px">
                                        <?= $row_profile->psd_birthdate != null ? abbreDate2($row_profile->psd_birthdate) : '' ?>
                                    </div>
                                    ...
                                    <div class="col-2 col-md-1 col-lg-3 text-start" style="padding-left:0px;">
                                        <?= $row_profile->psd_blood_id != null ? $row_profile->blood_name : '' ?>
                                    </div>
                                    ...
                                    <div class="col-2 col-md-2 col-lg-4  text-start" style="padding-left:0px;">
                                        <?= $row_profile->psd_nation_id != null ? $row_profile->country_name : '' ?>
                                    </div>
                                    ...
                                    <div class="col-2 col-md-3  text-start" style="padding-left:0px;">
                                        <?= $row_profile->psd_race_id != null ? $row_profile->race_name : '' ?>
                                    </div>
                                    <div class="col-3 col-md-2 col-lg-2" style="color:#777;padding-bottom:10px;padding-left:0px;padding-right:0px">
                                        ศาสนา
                                    </div>
                                    <div class="col-2 col-md-2  text-start" style="padding-left:0px;">
                                        <?= $row_profile->psd_reli_id != null ? $row_profile->reli_name : '' ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-12" style="padding-left: 30px;">
                                        <div>
                                            <span style="color:#777">
                                                <i class="bi bi-house font-30"></i> ที่อยู่ปัจจุบัน
                                            </span><br>
                                            <span style="padding-left:32px">
                                                <?= !empty($row_profile->psd_addcur_no) ? $row_profile->psd_addcur_no . ' ' : '' ?>
                                                <?= !empty($row_profile->psd_addcur_dist_id) ? ($row_profile->psd_addcur_pv_id != 1 ? "ต." : "แขวง") . $row_profile->dist_name . ' ' : '' ?>
                                                <?= !empty($row_profile->psd_addcur_amph_id) ? "อ." . $row_profile->amph_name . ' ' : '' ?>
                                                <?= !empty($row_profile->psd_addcur_pv_id) ? "จ." . $row_profile->pv_name . ' ' : '' ?>
                                                <?= !empty($row_profile->psd_addcur_zipcode) ? $row_profile->psd_addcur_zipcode : '' ?>
                                            </span>
                                        </div>
                                        <div>
                                            <span style="color:#777">
                                                <i class="bi bi-house font-30"></i> ที่อยู่ตามสำเนาทะเบียนบ้าน
                                            </span><br>
                                            <span style="padding-left:32px">
                                                <?= !empty($row_profile->psd_addhome_no) ? $row_profile->psd_addhome_no . ' ' : '' ?>
                                                <?= !empty($row_profile->psd_addhome_dist_id) ? ($row_profile->psd_addhome_pv_id != 1 ? "ต." : "แขวง") . $row_profile->home_dist_name . ' ' : '' ?>
                                                <?= !empty($row_profile->psd_addhome_amph_id) ? "อ." . $row_profile->home_amph_name . ' ' : '' ?>
                                                <?= !empty($row_profile->psd_addhome_pv_id) ? "จ." . $row_profile->home_pv_name . ' ' : '' ?>
                                                <?= !empty($row_profile->psd_addhome_zipcode) ? $row_profile->psd_addhome_zipcode : '' ?>
                                            </span>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <?= $row_profile->psd_cellphone == NULL || $row_profile->psd_cellphone == '' ? '' : $row_profile->psd_cellphone ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="tab-pane fade <?php echo $key == 0 ? 'show active' : ''; ?>"
                                        ...
                                        <div class="row font-18">
                                            <div class="col-md-12 row">
                                                ...
                                                <div class="col-md-8">
                                                    <?= $person_position_info[$row->dp_id]->pos_ps_code != null ? $person_position_info[$row->dp_id]->pos_ps_code : '21/334' ?>
                                                </div>
                                            </div>
                                            <div class="col-md-12 row">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-8">
                                                    <?= $person_position_info[$row->dp_id]->pos_work_start_date != null ? fullDateTH3($person_position_info[$row->dp_id]->pos_work_start_date) : 'ขุนทะเล' ?>
                                                </div>
                                            </div>
                                            <div class="col-md-12 row">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-8">
                                                    <?php if ($person_position_info[$row->dp_id]->admin_po != null) : ?>
                                                        <?php foreach ($person_position_info[$row->dp_id]->admin_po as $key => $admin) : ?>
                                                            <?= $admin->admin_name . "<br>" ?>
                                                        <?php endforeach; ?>
                                                    <?php else : ?>
                                                        -
                                            ...
                                            <div class="col-md-12 row">
                                                ...
                                                <div class="col-md-8">
                                                    <?= $person_position_info[$row->dp_id]->alp_name != null ? $person_position_info[$row->dp_id]->alp_name : 'ขุนทะเล' ?>
                                                </div>
                                            </div>
                                            <div class="col-md-12 row">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-8">
                                                    <?php if ($person_position_info[$row->dp_id]->admin_po != null) : ?>
                                                        <?php if (isset($person_position_info[$row->dp_id]->spcl_po)) : ?>
                                                            <?php foreach ($person_position_info[$row->dp_id]->spcl_po as $key => $spcl) : ?>
                                                                <?= $spcl->spcl_name . "<br>" ?>
                                                            <?php endforeach; ?>
                                                        <?php else : ?>
                                                            -
                                            ...
                                            <div class="col-md-12 row">
                                                ...
                                                <div class="col-md-8">
                                                    <?= $person_position_info[$row->dp_id]->hire_name != null ? $person_position_info[$row->dp_id]->hire_name : 'ขุนทะเล' ?>
                                                </div>
                                            </div>
                                            <div class="col-md-12 row">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-8">
                                                    <?= $person_position_info[$row->dp_id]->pos_active != null ? $person_position_info[$row->dp_id]->retire_name : '-' ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="tab profile-settings">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="d-grid col-4 mx-auto">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select class="form-select select2 ms-2 w-15" style="display: inline;" data-placeholder="-- กรุณาเลือกปี --" name="select_year_develop" id="select_year_develop">
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <ul class="nav nav-pills mb-3 mt-3" id="hr-tab" role="tablist">
                                                            <li class="nav-item" role="presentation">
                                                                <button class="nav-link active" id="hr-develop-in-tab" data-bs-toggle="pill" data-bs-target="#hr-develop-in" type="button" role="tab" aria-controls="hr-develop-in" aria-selected="true" style="margin-left: 13px;">หน่วยงานภายใน <span class="badge bg-success" id="summary-develop-in">2</span></button>
                                                            </li>
                                                            <li class="nav-item" role="presentation">
                                                                <button class="nav-link" id="hr-develop-out-tab" data-bs-toggle="pill" data-bs-target="#hr-develop-out" type="button" role="tab" aria-controls="hr-develop-out" aria-selected="false">หน่วยงานภายนอก <span class="badge bg-success" id="summary-develop-out">3</span></button>
                                                            </li>
                                                        </ul>
                                                                                    ...
                                                                                    <table class="table datatable table-hover" width="100%" id="table-develop-in">
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>การอบรมเชิงปฏิบัติการเรื่องการพัฒนาทักษะ</td>
                                                                                                <td class="text-center">12 ม.ค. 2567</td>
                                                                                                <td>ประชุม/อบรม/สัมมนา</td>
                                                                                                <td>กรมพัฒนาฝีมือแรงงาน</td>
                                                                                                <td class="text-center">8</td>
                                                                                                <td class="text-center">15,000</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td class="text-center">2</td>
                                                                                                <td>สัมมนาเรื่องนวัตกรรมเทคโนโลยี</td>
                                                                                                <td class="text-center">15 มิ.ย 2567</td>
                                                                                                <td>ประชุม/อบรม/สัมมนา</td>
                                                                                                <td>มหาวิทยาลัยเทคโนโลยี</td>
                                                                    ...
                                                                    <div class="card">
                                                                        <div class="accordion">
                                                                            <div class="accordion-item">
                                                                                <h2 class="accordion-header">
                                                                                    <button class="accordion-button accordion-button-table" type="button">
                                                                                        <i class="bi bi-table icon-menu"></i><span> ตารางรายการพัฒนาข้อมูลบุคลากรหน่วยงานภายนอก</span></span>
                                                                                    </button>
                                                                                </h2>
                                                                                    ...
                                                                                    <div class="accordion-body">
                                                                                        <table class="table datatable table-hover" width="100%" id="table-develop-out">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td class="text-center">1</td>
                                                                                                    <td>การอบรมภายในเรื่องการสื่อสาร</td>
                                                                                                    <td class="text-center">5 ก.พ. 2567</td>
                                                                                                    <td>ศึกษาดูงาน</td>
                                                                                                    <td>ฝ่ายการสื่อสาร</td>
                                                                                                    <td class="text-center">4</td>
                                                                                                    <td class="text-center">ไม่มีค่าใช้จ่าย</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td class="text-center">2</td>
                                                                                                    <td>การสัมมนาเรื่องการบริหารจัดการทีม</td>
                                                                                                    <td class="text-center">10 เม.ย 2567</td>
                                                                                                    <td>ประชุม/อบรม/สัมมนา</td>
                                                                                                    <td>ฝ่ายบริหารจัดการ</td>
                                                                                                    <td class="text-center">6</td>
                                                                                                    <td class="text-center">10,000</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td class="text-center">3</td>
                                                                                                    <td>การอบรมการใช้เครื่องมือใหม่</td>
                                                                                                    <td class="text-center">15 พ.ค. 2567</td>
                                                                                                    <td>ศึกษาดูงาน</td>
                                                                                                    <td>ฝ่ายเทคโนโลยี</td>
                                                                                                    <td class="text-center">3</td>
                    ...
                    <div class="card PersonalInfo-background-orange" id="SelfDevelopment-HRD-Section-2">
                        <div class="card-body">
                            <div class="accordion">
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                    ...
                                    <div id="collapse-hr-develop-in-tab" class="accordion-collapse collapse show">
                                        <div class="accordion-body">
                                            <table class="table datatable" width="100%">
                                                ...
                                                <tbody>
                                                    <?php if (!empty($person_external_service_list)) { ?>
                                                        <?php foreach ($person_external_service_list as $index => $service) { ?>
                                                            <tr>
