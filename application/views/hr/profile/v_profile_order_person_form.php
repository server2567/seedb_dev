            ...
            <div class="accordion-body">
                <div class="row">
                            ...
                            <?php foreach ($mn_option as $key => $value) : ?>
                                <optgroup label="<?= $value->st_name_th ?>">
                                    <?php foreach ($value->mn_name as $key => $mn): ?>
                                        <option value="<?= $mn['mn_id'] ?>" <?= !empty($ordt_info) &&  $ordt_info[0]->ordt_menu_id == $mn['mn_id'] ? 'selected' : '' ?>><?= $mn['mn_name_th'] ?></option>
                                    <?php endforeach; ?>
                                </optgroup>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="ordt_type_year" name="ordt_info[]" class="form-control select2" data-value="<?= isset($ordt_info) ? $ordt_info[0]->ordt_type_year:'' ?>">
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="ordt_year" name="ordt_info[]" class="form-control select2" data-value="<?=isset($ordt_info) ? $ordt_info[0]->ordt_year:'' ?>">
                            <option value="">--เลือกปี--</option>
                            <!-- JavaScript will populate the years here -->
                        </select>
                    </div>
