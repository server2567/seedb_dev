            ...
            success: function(data) {
                ...
                data.forEach(function(row, index) {
                    ...
                    var button = `  <div class="text-center option">
                                            <button class="btn btn-warning" title="คลิกเพื่อแก้ไขข้อมูล" data-toggle="tooltip" data-bs-placement="top" onclick="window.location.href='<?php echo site_url() . "/" . $controller_dir; ?>get_profile_official/${row.ps_id}'">
