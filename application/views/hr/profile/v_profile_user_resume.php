                    ...
                    <div id="collapseResume" class="accordion-collapse collapse show" aria-labelledby="HeadingResume" data-bs-parent="#accordionResume">
                        <div class="accordion-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-4">
                                    <label for="psd_psst_id" class="form-label">สถานภาพ</label>
                                ...
                                <div class="col-md-6 mt-2">
                                    <label for="psd_cellphone" class="form-label ">เบอร์โทรศัพท์มือถือ</label>
...
function profile_save_form() {
    ...
    // console.log("profile_resume_form", profile_resume_form);
     ...
     var excludeFields = ["psd_birthdate", "psd_blood_id", "psd_reli_id", "psd_race_id", "psd_nation_id", "psd_psst_id", "psd_picture", "psd_desc", "ps_nickname", "ps_nickname_en", 
                         "psd_facebook", "psd_line", "psd_cellphone", "psd_phone", 
                         "psd_ex_phone", "psd_work_phone"];
