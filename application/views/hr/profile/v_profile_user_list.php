                ...
                <div class="accordion-body">
                    <form class="row g-3" method="get">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="select2" class="form-select" id="select_status_id" name="select_status_id">
                                <option value="all" selected>ทั้งหมด</option>
            ...
            <div id="collapseShow" class="accordion-collapse collapse show">
                <div class="accordion-body">
                    <div class="btn-option mb-3">
                        <a class="btn btn-primary" href="<?php echo site_url() . "/" . $controller_dir . "profile_user_insert"; ?>" title="คลิกเพื่อเพิ่มรายชื่อบุคลากร" data-toggle="tooltip" data-placement="top">
                        <i class="font-20 bi bi-plus"></i> เพิ่มรายชื่อบุคลากร </a>
                    </div>
