            ...
            <div id="collapseAdd" class="accordion-collapse collapse show" aria-labelledby="headingAdd">
                <div class="accordion-body">
                    <form class="row g-3" method="get">
                        ...
                        <div class="col-md-3">
                            <label for="select_admin_id" class="form-label">ตำแหน่งในการบริหารงาน</label>
                            <select class="form-select select2" name="select_admin_id" id="select_admin_id">
                                <option value="all" selected>ทั้งหมด</option>
                                <?php
            ...
            success: function(data) {
                ...
                data.forEach(function(row, index) {
                    ...
                    var button =    `  <div class="text-center option">
                                            <button class="btn btn-primary" title="คลิกเพื่อดูรายละเอียดข้อมูล" data-toggle="tooltip" data-bs-placement="top" onclick="window.location.href='<?php echo site_url()."/".$controller_dir; ?>get_profile_summary/${row.ps_id}/2'">
                                                <i class="bi-search"></i>
                                            </button>
                                        </div>
                                    `;
