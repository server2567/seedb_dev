    ...
    <script>
        ...
        function createNodeStructure(nodeData) {
            ...
            <div>
                ...
                <div class="node-title">${nodeData.stdp_po_id == 1 ? 'หัวหน้าแผนก' : nodeData.stdp_po_id == 2 ? 'รองหัวหน้าแผนก' : 'สมาชิก'}</div>
            </div>`;
            }
                ...
                if (nodeData.personnel) {
                    nodeData.personnel.forEach((person, index) => {
                        ...
                        <div>
                            ...
                            <div class="node-title">${nodeData.stde_level < 3 ? '<br>' : person.stdp_po_id == 5 ? '-' : position[person.stdp_po_id]}</div>
                        </div>`;
                    });
                }
