                    ...
                    <div class="col-md-12">
                        <div class="row d-flex justify-content-center">
                            ...
                            <ul class="nav nav-pills mb-3 mt-3" id="hr-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="hr-develop-in-tab" data-bs-toggle="pill" data-bs-target="#hr-develop-in" type="button" role="tab" aria-controls="hr-develop-in" aria-selected="true" style="margin-left: 13px;">พัฒนาภายในโรงพยาบาล <span class="badge bg-success" id="summary-develop-in"><?= $devl_1 ?></span></button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="hr-develop-out-tab" data-bs-toggle="pill" data-bs-target="#hr-develop-out" type="button" role="tab" aria-controls="hr-develop-out" aria-selected="false">พัฒนาภายนอกโรงพยาบาล <span class="badge bg-success" id="summary-develop-out"><?= $devl_2 ?></span></button>
                                </li>
                            </ul>
