    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex justify-content-between">
                ...
                <button type="button" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="คลิกเพื่อลบกิจกรรม" id="deleteEvent">ลบกิจกรรม</button>
                <button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="คลิกเพื่อบันทึกกิจกรรม" id="updateEvent">บันทึกกิจกรม</button>
            </div>
        </div>
    </div>
</div>
