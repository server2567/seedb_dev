<div class="modal fade" id="ums_system_modal" tabindex="-1">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" id="ums_hidden_st_id" value=""> <!-- Hidden input field to store st_id -->
                <div class="mb-3 text-end">
                    <button class="btn btn-primary" title="คลิกเพื่อเข้าสู่ระบบ" data-toggle="tooltip" data-placement="top" onclick="redirect_to_gear('ums')"> <i class="bi-arrow-right-square"></i> เข้าสู่ระบบ </button>
                </div>
                <div class="card">
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button accordion-button-table" type="button">
                                                <i class="bi-bell icon-menu"></i><span>  รายการแจ้งเตือน</span><span class="badge bg-success">1</span>
                                            </button>
                                        </h2>
                                                ...
                                                <table class="table datatable" width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>อนุมัติการเพิ่มสิทธิ์ <b>"ผู้ดูแลระบบ"</b> ให้กับ <b>"กลุ่มผู้ดูแลระบบ"</b> ในระบบการบริหารจัดการผู้ใช้งานระบบ</td>
                                            ...
                                            <div class="accordion-body">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="text-center"><?php echo $i+1; ?></td>
                                                            <td>เพิ่มสิทธิ์ <b>"ผู้ดูแลระบบ"</b> ให้กับ <b>"กลุ่มผู้ดูแลระบบ"</b> ในระบบการบริหารจัดการผู้ใช้งานระบบ</td>
