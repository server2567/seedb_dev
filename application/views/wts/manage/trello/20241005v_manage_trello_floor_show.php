        ...
        <div class="accordion-item">
            <h2 class="accordion-header">
                <button class="accordion-button accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTable" aria-expanded="true" aria-controls="collapseTable">
                    <i class="bi-newspaper icon-menu"></i><span class="span-stde pe-1"></span><span class="span-date pe-1"></span> <span class="badge bg-success font-14 badge-count-total"></span><span onclick="refreshQue()" style="margin-left: 15px;"><span class="btn btn-warning"> Reset เมื่อมีจำนวนผู้ป่วยใหม่</span><span class="badge bg-danger row-number" style="position: relative;top: -8px;left: -10px;"></span></span>
                </button>
            </h2>
                                ...
                                <div class="card m-3 p-2 pb-0">
                                    <div class="card-header fw-bold mb-2" style="<?php echo $bg_color; ?>">
                                        <div class="doctor-detail">
                                            ...
                                            <p class="mb-2 stde-name-th" data-doctor-id="<?php echo $doctor['ps_id']; ?>">
...
<script>
    ...
    function reset_interval() {
        ...
        refreshInterval = setInterval(function() {
            // reload_que();
            get_new_patient();
        }, 5000); // 60000 - 1 minute // or datatable_second_reload
    }
...
<script>
    ...
    function select_doctor() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire(`คุณเลือก: ${result.value}`);
            }
        });
