                    ...
                    <div class="container-que scroll-x-container">
                        ...
                        <div class="col-md-4">
                            <div class="card m-3 p-2 pb-0">
                                ...
                                <div class="sortable-list p-0" id="tasks-wait">
                        ...
                        <?php foreach ($get_doctors as $doctor): ?>
                            <div class="col-md-4" style="display:none;">
                                <div class="card m-3 p-2 pb-0">
                                    <div class="card-header bg-primary text-white fw-bold mb-2">
                                    ...
                                    <div class="sortable-list p-0" id="tasks-<?php echo $doctor['ps_id']; ?>">
                                        <!-- Tasks will be dynamically added here -->
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="card m-3 p-2 pb-0">
                                ...
                                <div class="sortable-list p-0" id="tasks-cancel">
                                    <!-- Tasks will be dynamically added here -->
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    var search_params = [];
    let refreshInterval;
    let wts_stde_id_session = '<?php echo $wts_stde_id; ?>';
            ...
            success: function(response) {
                ...
                result.tasks.forEach(function(task, index) {
                    ...
                    if (!isDuplicate) {
                        ...
                        if(!task.pri_name && !task.pri_color && task.apm_app_walk) {
                            pri_name = task.apm_app_walk == 'W' ? 'Walk-in' : 'นัดหมาย';
                            pri_color = task.apm_app_walk == 'W' ? '#012970' : '#00FF44';
                        }

                        // Manually create the HTML string
                        var taskHtml = '<div class="sortable-item card-body rounded ' + bg_class + ' shadow-2 mb-2" data-task-id="' + task.apm_ql_code + '" data-task-apm-id="' + task.apm_id + '" data-origin-list-id="' + ori_list_id + '">';
    ...
    function getSearchParams() {
        ...
        if (selectedDepartment.length) {
            ...
            badges.forEach(badge => {
                badge.innerHTML = `ข้อมูลผู้ป่วยที่รอรับการตรวจของ ${selectedDepartmentText}`;
            });
        }
