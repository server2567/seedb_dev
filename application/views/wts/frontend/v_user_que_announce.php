...
">
    <!-- Left partition -->
    <div class="col-5 d-flex justify-content-end align-items-end" style="position: relative; height: 50px;">
        <h5 style="position: absolute; bottom: 0; right: 0; top:40px; margin-right: -105px;">
...
<div class="col-5 g-3 mt-3 queue-container" >
...
<div class="col-7 g-3 mt-3 queue-container" >
<div class="card-body" >
    <?php
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <?php for ($index = 0; $index < count($news); $index++) : ?>
                    ...
                    <div class="mx-auto">
                      <div class="row" style="margin-left: -70px; margin-right: -68px; ">
                        <div class="col-12 d-flex align-items-center justify-content-center">
                          <button type="button" class="btn" data-bs-target="#carouselExampleCaptions" data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                          </button>
                          <div class="flex-shrink-1 mx-0 d-flex align-items-center justify-content-center">
                            <img class="border img-thumbnail" style=" height: 570px; width:1000px;" src="<?= site_url($this->config->item('ums_dir') . 'getIcon?type=' . $this->config->item('ums_news_dir') . 'img&image=' . ($news[$index]->news_img_name != '' ? $news[$index]->news_img_name : 'default.png')) ?>" alt="News Image" class="img-fluid">
                          </div>
...
// setInterval(show_announce, 15000);
