...
<body onload="window.print(); window.onafterprint = function(){ window.close(); }">
    <div class="container">
        <!-- Header Section -->
        <div class="header2" style="margin-top: 0px; font-size:20pt;">
        <img src="<?php echo base_url(); ?>/assets/img/apple-touch-icon2.png" alt="" class="img-width" style="width:150px; margin-right: 15px;">
            <span style="margin-top: 1%;">
              โรงพยาบาลจักษุสุราษฎร์<br> 
              SURAT EYE HOSPITAL
            </span>
            <span style="font-weight: 400; margin-left: 25%; margin-top: 0%; font-size:16pt;">
              44/1 ศรีวิชัย ต.มะขามเตี้ย <br>อ.สุราษฎร์ธานี จ.สุราษฎร์ธานี 84000<br>
              โทร 077-276-999
            </span>
        </div>
        <!-- Patient Information -->
        <div class="patient-info mt-5 p-3 pt-2" style='border:1.5px solid #455a64;'>
