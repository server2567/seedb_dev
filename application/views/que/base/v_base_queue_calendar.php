<h4 class="partial-name"><span>ปฏิทินการเปิดจองคิว</span></h4>
<div><button class="float-end btn btn-primary" onclick="window.location.href='<?php echo base_url()?>index.php/que/Base/queue_show'" type="submit"><i class="bi bi-success">เปิดการจองคิว</i></button></div>
...
console.log(action);
    ...
    var schedules = [{
        ...
        id: '1',
        calendarId: '1',
        title: 'นายแพทย์ นัทธ์ รุ่งรัศมีทรัพย์ เวลา 9.00-16.00',
        category: 'time',
        dueDateClass: '',
        start: '2024-05-8',
        end: '2024-05-10'
      },
      {
        id: '2',
        calendarId: '1',
        title: 'นายแพทย์ ธณิกา ก้องวัฒนะกุล เวลา 9.00-16.00',
        category: 'time',
        dueDateClass: '',
        start: '2024-05-8',
        end: '2024-05-10'
      },
      {
        id: '3',
        calendarId: '1',
        title: 'นายแพทย์ ปิติภัทร แสนธารา',
        category: 'time',
        dueDateClass: '',
        start: '2024-04-20',
        end: '2024-04-20'
      ...
      },
      {
        id: '5',
        calendarId: '1',
        title: 'นาย ธณิกา ก้องวัฒนะกุล เวลา 16.00-20.00',
        category: 'time',
        dueDateClass: '',
        start: '2024-05-13',
        end: '2024-05-17'
      },
      {
        ...
        id: '6',
        calendarId: '1',
        title: 'นาย พัชญ์ธนัน แสนธารา opd ห้อง 5',
        category: 'time',
        dueDateClass: '',
        start: '2024-04-22',
        end: '2024-04-25'
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        นาย ธณิกา ก้องวัฒนะกุล opd ห้อง 3 <br>
        นาย จิริเดช ป้อมใหญ่ opd ห้อง 2 <br>
        <div class="badge bg-danger">(กะบ่าย)</div><br>
        นาย รัชนวีระ พัชญ์ธนัน opd ห้อง 1 <br>
        
        <div class="badge bg-primary">(กะเย็น)</div><br>
        นาย จิริเดช ป้อมใหญ่ opd ห้อง 1 <br>
