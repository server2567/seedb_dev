...
class Health_right extends QUE_Controller
{
  ...
  function index()
  {
    ...
    $data['count_apm'] = $this->M_que_appointment->get_appointment_count_health_right(NULL);
    ...
    $this->output('que/health_right/v_health_right_show', $data);
  }
  ...
  public function get_appointments()
  {
    try {
      ...
      $appointments = $this->M_que_appointment->get_appointments_paginated_health_right($start, $length, $order_column, $order_dir, $searchParams);
      $total_appointments_result = $this->M_que_appointment->get_appointment_count_health_right($searchParams);
      $total_appointments = $total_appointments_result->appointment_count;
