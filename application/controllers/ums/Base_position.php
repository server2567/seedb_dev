...
class Base_position extends UMS_Controller
{
	...
	public function index() {
		...
		$this->output('ums/base/v_base_position_show',$data);
	}
	...
	public function edit($StID=null) {
		...
		$data['session_mn_active_url'] = $this->uri->segment(1) . '/' . $this->uri->segment(2); // set session_mn_active_url / breadcrumb
		$data['status_response'] = $this->config->item('status_response_show');;
		$this->output('ums/base/v_base_position_form',$data);
	}
	
	public function add() {
		//// case success
        $data['returnUrl'] = base_url().'index.php/ums/Base_position';
