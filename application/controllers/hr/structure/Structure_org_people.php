...
class Structure_org_people extends Structure_Controller{
	...
	public function index() {
		...
		$this->output('hr/structure/v_structure_org_people_show',$data);
	}
	...
	public function view($StID=null) {
		$data['Menus'] = [
			[
				...
				'MnUrl' => null,
				'MnUrlText' => null,
				'MnNameT' => "จัดการโครสร้างองค์กร ตำแหน่ง และประเภทบุคลากร"
			],
			[
				'MnID' => 52,
				'MnStID' => 1,
				...
				'MnUrl' => "ums/Title",
				'MnUrlText' => null,
				'MnNameT' => "จัดการข้อมูลตำแหน่งของบุคลากร"
			]
		];
		$this->setUrl($data['Menus']);

		$data['status_response'] = $this->config->item('status_response_show');;
		$this->output('hr/structure/v_structure_org_people_form',$data);
	}
