...
class Structure_base_special_position extends Structure_Controller{
	private $mn_active_id = 300038;
	...
	public function index() {
		...
		$this->output('hr/structure/v_structure_base_special_position_show',$data);
	}

	public function view($StID=null) {
		$data['session_mn_active_id'] = $this->mn_active_id;
		$data['status_response'] = $this->config->item('status_response_show');;
		$this->output('hr/structure/v_structure_base_special_position_form',$data);
	}
