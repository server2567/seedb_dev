...
class Directory_profile extends UMS_Controller
{
	...
	function index()
	{
		...
		$data['ddd'] = array();
		$this->output_frontend_staff('staff/v_staff_directory_profile', $data);
	}
	...
	public function nurses()
	{
		...
		$data['filter_profile'] = $this->M_staff_profile->filter_profile_option($is_medical)->result();
		$this->output_staff('staff/v_nurses', $data);
	}
	...
	public function staff()
	{
		...
		$this->output_staff('staff/v_staff', $data);
	}
