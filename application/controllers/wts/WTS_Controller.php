...
class WTS_Controller extends UMS_Controller
{
	...
	function index(){
      ...
      $redirect_urls = [
        ...
        'wts_user_oph' => 'wts/Manage_queue_trello/floor',
        'wts_user_ent' => 'wts/Manage_queue_trello/floor',
        'wts_user_den' => 'wts/Manage_queue_trello/floor',
        'wts_user_rad' => 'wts/Manage_queue_trello/floor',
        'wts_user_lcc' => 'wts/Manage_queue_trello/floor',
    ];
