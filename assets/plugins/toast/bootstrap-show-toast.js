...
;(function (bootstrap) {
    ...
    function Toast(props) {
        ...
        this.props = {
            ...
            headerClass: "", // [AP] 20240315 Add 'headerClass' for the appearance of header
        ...
        if (showHeader) {
            toastHeader = `<div class="toast-header ${this.props.headerClass}">
